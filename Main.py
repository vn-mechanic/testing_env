...
ania = os.environ['ania']
lera = os.environ['lera']
murchik = os.environ['murchik']
rymlianyn = os.environ['rymlianyn']
...
def send_welcome(message):
    ...
    if "МАРІК" in str(message.text.upper()) or "МАРИК" in str(message.text.upper()) or "MARIK" in str(message.text.upper()):
        ...
        if message.from_user.id == ania: # ania.me script
        ...
        elif message.from_user.id == lera: # d15hw45h3r script
            random_number = randint(-10, 10)
